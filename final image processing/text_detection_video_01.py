# USAGE
# python text_detection_video_01.py --east frozen_east_text_detection.pb
...
location_01=["BANESHWOR", "KOTESHWOR", "JADIBUTI","SINAMANGAL","GWARKO","BALKUMARI","LUBHU","PQR","ABC"]
src_path = "C:\\Users\\Dell\\Desktop\\Hackathon\\final image processing"
...
def get_string(img_path):
    ...
    cv2.imwrite(src_path + "\\after_noise.png", img)
    ...
    result = pytesseract.image_to_string(Image.open(src_path + "\\final.png"))
...
while True:
	...
	im = Image.open(r"C:\\Users\\Dell\\Desktop\\Hackathon\\final image processing\\saved_img.png")
	...
	if (abs(distance1)):
		im1.save("C:\\Users\\Dell\\Desktop\\Hackathon\\final image processing\\final_saved.png", "PNG")
